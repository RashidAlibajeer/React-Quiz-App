        ...
        return (
            <div>
                ...
                {startQuiz ?
                    ...
                    <div className="introQuiz" style={{ border: "1px solid" }}>
                    ...
                    <div className="introQuiz">
                        <span className="introQuizS1">Welcome to Knowledge Quiz</span>


                        {getRes ?
                            <div className="disc" style={{ minHeight: "0px", height: "auto", transitionDuration: "214ms" }}>
                                <div style={{ display: "flex" }}>
                                    <div style={{ padding: 20, width: "100%", border: "1px solid gray", }}>
                                        <h2 style={{ textAlign: "center", background: "red", padding: "20px 10px", borderRadius: 20, width: 500 }}>Description About Result</h2>
                                        {resfail ?
                                            <div style={{ display: "flex", padding: "10px 35px 50px", }}>
                                                <div style={{ width: "100%", marginTop: "1%", textAlign: "center" }}>
                                                    <b style={{ color: "black", fontSize: "1.5em" }}>Congratulation! You are Passed</b>
                                                    <br />
                            ...
                            <div className="disc" style={{ minHeight: "0px", height: "auto", transitionDuration: "214ms" }}>
                                <div style={{ display: "flex" }}>
                                    <div style={{ width: "100%", border: "1px solid gray", borderRadius: 30, padding: 10, margintop: 10, }}>
                                        <h2 style={{ textAlign: "center", background: "red", padding: "10px 5px", borderRadius: 20 }}>Description About Quiz</h2>
